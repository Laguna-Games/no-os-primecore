...
import {CutDN404Diamond} from '../../src/implementation/CutDN404Diamond.sol';

library CutDN404DiamondDeployLib {
    string public constant IMPLEMENTATION_NAME = 'CutDN404Diamond';
    ...
    function deployNewInstance() internal returns (address implementation) {
        implementation = address(new CutDN404Diamond());
        console.log(
            string.concat(
